...
class DatePicker(VanillaBaseControl):
    ...
    def __init__(self, posSize, date=None, minDate=None, maxDate=None, showStepper=True, mode="text", timeDisplay="hourMinuteSecond", dateDisplay="yearMonthDay", callback=None, sizeStyle="regular"):
        """
        *posSize* Tuple of form (left, top, width, height) representing the position and size of the date picker control.

        |\\3. *Standard Dimensions - Text Mode* |
        | Regular | H | 22                      |
        | Small   | H | 19                      |
        | Mini    | H | 16                      |

        |\\3. *Standard Dimensions - Graphical Mode* |
    ...
    def getNSDatePicker(self):
        """
        Return the _NSDatePicker_ that this object wraps.
        """
