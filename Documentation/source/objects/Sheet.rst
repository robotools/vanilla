...
.. method:: Sheet.assignToDocument(document)
...
.. method:: Sheet.getNSWindow()

    Return the *NSWindow* that this Vanilla object wraps.


.. method:: Sheet.getNSWindowController()
...
.. method:: Sheet.makeKey()

    Make the window the key window.


.. method:: Sheet.makeMain()

    Make the window the main window.


.. method:: Sheet.setTitle(title)
...
.. method:: Sheet.move(x, y, animate=True)

    Move the window by **x** units and **y** units.


.. method:: Sheet.resize(width, height, animate=True)

    Change the size of the window to **width** and **height**.


.. method:: Sheet.setDefaultButton(button)
...
.. method:: Sheet.bind(event, callback)
...
.. method:: Sheet.unbind(event, callback)
...
.. method:: Sheet.addToolbar(toolbarIdentifier, toolbarItems, addStandardItems=True)
